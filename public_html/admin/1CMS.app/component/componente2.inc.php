<!-- START HEADER -->
<h1><?php echo $app_icon; ?> Componente2  </h1>
<!-- END HEADER -->
<ul>
...
<?php
      ...
      if (!empty($_POST['save'])) {
          ...
          global $var2;
          $var2=2;
          $compoment_content->save((int)$_GET['section_id'], (int)$var2);
          notices::add('success', language::translate('success_changes_saved', 'Changes saved'));
...
?>
  ...
  <label><?php echo language::translate('title_new_video', 'New Video'); ?></label>

    ...
    class ctrl_pages_section_custom{
        ...
        public function load($id){
...

            {
                ...
                $section_components = database::query(
                    ...
                    ' WHERE pages_section_custom_id= ' . (int)$this->data['id']
                );
        ...
        public function loadComponents(){//Obtiene los componentes de la seccion
            ...
            $query =   database::query(
                ...
                " INNER JOIN " . DB_TABLE_PAGES_CONTENT_CUSTOM ." AS content ON content.pages_section_custom_id = section.id " .
                " INNER JOIN " . DB_TABLE_PAGES_COMPONENT_CUSTOM . " AS component ON component.id = content.pages_component_custom_id " .
        ...
        public function loadComponentsDetail(){
            ...
            $query = database::query(
                ...
                " INNER JOIN " .  DB_TABLE_PAGES_CONTENT_CUSTOM . " AS content ON content.pages_custom_id=page.id " .
                " INNER JOIN " . DB_TABLE_PAGES_COMPONENT_CUSTOM . " AS component ON component.id = content.pages_component_custom_id " .
        ...
        public function save($pages_custom_id=null){
            if(empty($this->data['id'])){ // Si no hay ID es porque es un registro nuevo
                database::query(
                    "insert into " . DB_TABLE_PAGES_SECTION_CUSTOM . 
                    "(position, name,pages_custom_id) values " .
                    "('" . $this->data['position'] . "', '" .  $this->data['name'] ."', '" . $pages_custom_id  . "')"
                );
                ...
                database::query(
                    ...
                    " position='" . $this->data['position'] . "', name='" . $this->data['name'] . "', pages_custom_id='" . $this->data['pages_custom_id'] . "'" .

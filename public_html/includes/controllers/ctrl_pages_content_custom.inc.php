<?php
    class ctrl_pages_content_custom{
        ...
        public function save($pages_section_custom_id=null, $v=null){
            if(empty($this->data['id'])){// Si no hay ID es porque es un registro nuevo
                database::query(
                    ...
                    "( '" . json_encode($this->data['component_content']) . "','" . $this->data['position']  . "', '". $pages_section_custom_id . "','" . $v ."')" //ESTE ID SE DEBE CAMBIAR PARA LOS COMPONENTES
                );
